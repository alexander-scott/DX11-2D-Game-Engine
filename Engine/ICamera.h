...
public:
	...
	virtual void DrawTextScreenSpace(std::string text, Vec2 pos, float rot, float* rgb, float scale) = 0;
	virtual void DrawTextWorldSpace(std::string text, Vec2 pos, float rot, float* rgb, float scale) = 0;
